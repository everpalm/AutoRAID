...
#     This class uses the `Win10Interface` to execute I/O operations and
#     analyze
...
#             AMD64MultiPathStress.CPU_GROUP = "0,0"  # Default CPU group 0,
#          CPU0
...
class AMDStressFactory(BaseStressFactory):
    def initiate(self, os_type: str, **kwargs) -> BaseStress:
        if os_type == 'Windows':
