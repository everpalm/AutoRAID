...
def my_app(cmdopt) -> api:
    """Fixture to set up the application API.

    Args:
        cmdopt (dict): A dictionary containing options such as:
            - 'mode': The mode to run the application in.
            - 'if_name': The interface name.
            - 'config_file': The path to the configuration file.

    Returns:
        api: An instance of the API initialized with the provided options.
    """
