...
class TestBeidou:
    ...
    def test_get_hyperthreading(self, beidou):
        """Test for verifying hyperthreading setting.

        Args:
            beidou: The system instance being tested.
        """
        logger.info("hyperthreading = %s",
                    beidou.hyperthreading)
