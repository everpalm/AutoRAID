                ...
                '$project': {
                    'write_pattern': {
                        '$convert': {
                            'input': {
                                '$arrayElemAt': [
                                    '$write_pattern_string.captures', 0
                                ]
                            }, 
                            'to': 'int', 
                            'onError': None, 
                    ...
                    'iodepth': {
                        '$convert': {
                            'input': {
                                '$arrayElemAt': [
                                    '$write_pattern_string.captures', 1
                                ]
                            }, 
                            'to': 'int', 
                            'onError': None, 
